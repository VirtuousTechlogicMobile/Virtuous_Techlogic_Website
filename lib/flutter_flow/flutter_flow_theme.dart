...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color footer = const Color(0xFF002743);
  late Color text16Color = const Color(0xFF3D4163);
  late Color text16Colo2 = const Color(0xFF676767);
  late Color black = const Color(0xFF000000);
  late Color datecolor = const Color(0xFFA6A6A6);
  late Color footerTextColor = const Color(0x98FFFFFF);
  late Color formColor = const Color(0xFFA7A7A7);
}
