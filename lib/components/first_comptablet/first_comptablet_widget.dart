      ...
      child: Stack(
        ...
        children: [
              ...
              children: [
                      ...
                      children: [
                          ...
                          Builder(
                            builder: (context) => wrapWithModel(
                              ...
                              child: GetInTouchButtonCompWidget(
                                ...
                                buttonAction: () async {
                                  logFirebaseEvent(
                                      'FIRST_COMPTABLET_Container_57o6w69u_CALL');
                                  await showDialog(
                                    context: context,
                                    builder: (dialogContext) {
                                      return Dialog(
                        ...
                        wrapWithModel(
                          ...
                          child: BrowseServicesButtonCompWidget(
                            action: () async {
                              logFirebaseEvent(
                                  'FIRST_COMPTABLET_Container_vi669qtt_CALL');
                ...
                Expanded(
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/images/Group_275_(1).png',
                      fit: BoxFit.contain,
                    ),
                  ).animateOnPageLoad(
          ...
          if (responsiveVisibility(
            ...
            Align(
              alignment: const AlignmentDirectional(-1.19, -0.71),
              child: Padding(
          ...
          if (responsiveVisibility(
            ...
            Align(
              alignment: const AlignmentDirectional(0.54, -0.59),
              child: Padding(
          ...
          if (responsiveVisibility(
            ...
            Align(
              alignment: const AlignmentDirectional(0.76, -0.68),
              child: Padding(
